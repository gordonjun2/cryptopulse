...
class BinanceClient:
    ...
    def get_symbol_precision_value(self, symbol):
        """Get precision value for a specific symbol"""
        if isinstance(self.perps_tokens, dict):
    ...
    def is_symbol_available(self, symbol):
        ...
        elif isinstance(self.perps_tokens, list):
            return symbol in self.perps_tokens
        return False